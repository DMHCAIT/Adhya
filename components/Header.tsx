    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#FAF9F7]/95 backdrop-blur-md border-b border-[#C8A96A]/20 shadow-sm">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="absolute left-1/2 -translate-x-1/2 lg:static lg:translate-x-0 flex items-center py-2">
            <div className="relative h-12 w-auto aspect-[3/1] lg:h-16">
              <Image
                src="/logo.jpg"
                alt="ADHYA Studio"
                fill
